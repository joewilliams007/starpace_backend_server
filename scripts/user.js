...
module.exports = (req, res) => {
    ...
    if (type == "stars-post") {
        db.query(
            `
            SELECT Vote.user_id, Vote.timestamp,Users.user_id, Users.username, Users.votes, Users.image, Users.image_path, Users.isVerify
            FROM Vote
        ...
        db.query(
            `
            SELECT Vote_poll.user_id, Vote_poll.timestamp,Users.user_id, Users.username, Users.votes, Users.image, Users.image_path, Users.isVerify
            FROM Vote_poll
        ...
        db.query(
            `SELECT user_id, username, votes, image, image_path,isVerify
            FROM Users
